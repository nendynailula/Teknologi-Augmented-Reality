// Lens Studio Version: 4.28.1
// Snapchat Version: 11.93
...
declare namespace TensorMath {
    ...
    */
    export function applyThreshold(inTensor: Float32Array, threshold: number, maxValue: number, type: TensorMath.ThresholdMethod, UNKNOWNNAME: Float32Array): void
...
interface WorldTrackingPlanesAddedEvent extends SceneEvent {
    /**
    * @description Returns an array of newly added [TrackedPlanes](https://lensstudio.snapchat.com/api/classes/TrackedPlane).
    */
...
interface WorldTrackingPlanesRemovedEvent extends SceneEvent {
    /**
    * @description Returns an array of [TrackedPlanes](https://lensstudio.snapchat.com/api/classes/TrackedPlane) that are no longer detected.
    */
    getPlanes(): TrackedPlane[]
...
interface WorldTrackingPlanesUpdatedEvent extends SceneEvent {
    /**
    * @description Returns an array of [TrackedPlanes](https://lensstudio.snapchat.com/api/classes/TrackedPlane) that were updated.
    */
    getPlanes(): TrackedPlane[]
